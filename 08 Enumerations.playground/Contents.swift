...
let earthsOrder = APlanet.earth.rawValue
// earthsOrder is 3
...
let possiblePlanet = APlanet(rawValue: 7)
// possiblePlanet is of type APlanet? and equals APlanet.uranus

let positionToFind = 11
if let somePlanet = APlanet(rawValue: positionToFind) {
    switch somePlanet {
    case .earth:
        print("Mostly harmless")
    default:
